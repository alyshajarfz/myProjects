...
<div class="side-header">
    <img src="./assetsmin/images/logo.png" width="120" height="120" alt="Swiss Collection"> 
    <h5 style="margin-top:10px;">Hello, Admin</h5>
</div>

<hr style="border:1px solid; background-color:#8a7b6d; border-color:#a08462;">
    ...
    <a href="admin.php"><i class="fa fa-th"></i> Dish</a>
